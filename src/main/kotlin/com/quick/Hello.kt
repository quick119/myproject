...
fun main(args: Array<String>) {     //main方法可以在最外層
    ...
    val h = Human("Hank", 66.5f, 1.7f)              //建構物件的方法，叫做建構子
    h.hello()
    print(h.bmi())
    val age = 19 //自動推斷資料型態為Int, val為常數 不能再給別的值
    var age1 =20 //var為變數值，可以改變
    var name :String //用冒號來指定資料型態
    name = "Jack"
...
class Human constructor(var weight:Float, var height: Float) {         //主要、次要建構子，只要在類別名後加括號就是, constructor可省略
    init {
